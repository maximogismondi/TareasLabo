...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        fecha_hoy.set_dia(ingreso.nextInt());
        System.out.println("Mes: ");
        fecha_hoy.set_mes(ingreso.nextInt());
        System.out.println("Anio: ");
        fecha_hoy.set_anio(ingreso.nextInt());
        Hotel hotel = new Hotel(fecha_hoy);

        while(seguir){
            hotel.liberar_huespedes();
            ...
            switch (opcion){
                ...
                case 2:
                    ...
                    break;
                case 3:
                    ArrayList<Huesped> top_6_huespedes = hotel.top_6_huespedes();
                    for(Huesped huesped:top_6_huespedes){
                        if (huesped.get_edad() != -1 || huesped.get_dni() != -1) {
                            System.out.println(huesped.get_nombre() + " " + huesped.get_apellido());
                        }
                    }
                    break;
                case 4:
                    ArrayList<Habitacion> top_3_habitaciones = hotel.top_3_habitaciones();
                    for(Habitacion habitacion : top_3_habitaciones){
                        if(habitacion.get_nro_habitacion() != -1){
                            System.out.println("Habitacion nro " + (habitacion.get_nro_habitacion()+1));
                        }
                    }
                    break;
                case 5:
                    double dinero_total = hotel.dinero_recaudado_total();
                    System.out.println("La cantidad total de dinero recaudada es: $" + dinero_total);
                    break;
                case 6:
                    int cant_huespedes_estadia_prolongada = hotel.cant_huespedes_estadia_prolongada();
                    System.out.println("La cantidad de huespedes con estadia prolongada es: " + cant_huespedes_estadia_prolongada);
                    break;
                case 7:
                    ArrayList<Integer> habitaciones_ocupadas= hotel.lista_habitaciones_ocupadas();
                    ...
                    break;
                case 8:
                    ArrayList<Integer> habitaciones_libres= hotel.lista_habitaciones_libres();
                    ...
                    break;
                case 9:
                    hotel.huespedes_por_habitaciones();
                    break;
                case 10:
                ...
                case 11:
                    ...
                    hotel.fechas_entrada_salida(dni_huesped_a_consultar_fecha);
                    break;
                case 12:
                    System.out.println();
                    System.out.println("Ingrese el dni del huesped");
                    int dni_huesped_a_agregar_dias = ingreso.nextInt();
                    hotel.agregar_dias_estadia(dni_huesped_a_agregar_dias);
                    break;
                case 13:
                    System.out.println();
                    System.out.println("Ingrese el dni del huesped");
